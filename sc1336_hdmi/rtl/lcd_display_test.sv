...
// PATH:                   E:\E_EngineeringWarehouse\FPGA_ISP\FPGA_ISP\hdmi_display\rtl\lcd_display_test.sv
// Descriptions:
//
//----------------------------------------------------------------------------------------
...
//------------------------------------
//4 picture cycle cnt — switch on vsync falling edge (start of blanking)
reg             [   1: 0]      image_cnt;
reg                             switch_pending;
reg                             vsync_d1;
